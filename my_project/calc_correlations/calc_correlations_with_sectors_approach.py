...
def calc_correlations_with_sectors_approach(radius_km=1, n_sectors=4):
    ...
    silpo_stores_coords = silpo_shops_data[['lat', 'long']].values
    region_competitors_stores_coords = competitors_stores_data[['Latitude', 'Longitude']].values
    pop_coords = populations_data[['lat', 'lon']].values
    ...
    silpo_shops_data['store_density_3km'] = store_density_3km
    ...
    silpo_shops_data['population_uniformity_3km'] = population_uniformity

    silpo_shops_data['population_store_ratio_3km'] = silpo_shops_data['population_density_3km'] / silpo_shops_data[
        'store_density_3km'].replace(0, np.nan)
    silpo_shops_data['pop_metric_store_ratio_3km'] = silpo_shops_data['population_metric_sum_3km'] / silpo_shops_data[
        'store_density_3km'].replace(0, np.nan)
    ...
    silpo_shops_data.to_excel(output_path + 'correlation_sectors_approach_data.xlsx', index=False)
    ...
    return silpo_shops_data, correlation_results
